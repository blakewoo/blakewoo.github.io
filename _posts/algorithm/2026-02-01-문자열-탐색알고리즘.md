...
![img.png](/assets/blog/algorithm/string_match/img_6.png)

![img_1.png](/assets/blog/algorithm/string_match/img_7.png)
...
![img_2.png](/assets/blog/algorithm/string_match/img_8.png)
...
![img_3.png](/assets/blog/algorithm/string_match/img_9.png)

INDEX 5부터 매치가 안되었다. 이때 LSP Pointer는 현재 위치 -1 Index의 값을 가져와서 LSP Pointer를 옮기고 해당 위치의 Pattern 부터 검색하기 시작한다.

![img_4.png](/assets/blog/algorithm/string_match/img_10.png)

LPS Pointer는 A를 가리키나 현재 텍스트값은 D이다. 맞지 않는데, 이미 LSP Pointer의 Index가 0이므로 Text Pointer를 1 옮긴다.

![img_5.png](/assets/blog/algorithm/string_match/img_11.png)

![img_6.png](/assets/blog/algorithm/string_match/img_12.png)
...
![img_7.png](/assets/blog/algorithm/string_match/img_13.png)

index 5에서 불일치가 일어났다. 불일치 값은 D이므로 패턴중에 가장 오른쪽에 있는 D값을 찾아서 아래의 그림과 같이 땡긴다.

![img_8.png](/assets/blog/algorithm/string_match/img_14.png)

만약 아래와 같이 문자 탐색간 불일치가 일어났으나 불일치한 문자와 동일한 문자가 패턴 내에 없다면

![img_9.png](/assets/blog/algorithm/string_match/img_15.png)

아예 불일치한 문자 뒤로 패턴 index를 넘긴다.

![img_10.png](/assets/blog/algorithm/string_match/img_16.png)
