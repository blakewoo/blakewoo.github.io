...
![img.png](/assets/blog/distributed_parallel_computing/distributed_system_overview/img.png)

### 2) Peer-to-Peer
Bittorrent나 블록체인에서 사용하는 방식으로 각 Node들이 클라이언트이자 서버이며 Node끼리 요청을 주고 받는 구조이다.

![img_1.png](/assets/blog/distributed_parallel_computing/distributed_system_overview/img_1.png)

### 3) Publish-Subscribe
배포자(Publisher)와 구독자(Subscriber)로 나뉘며 배포자는 구독자들을 대상으로 어떤 토픽에 대해서 메세지를 뿌리는 방식이다.

![img_2.png](/assets/blog/distributed_parallel_computing/distributed_system_overview/img_2.png)
...
![img_3.png](/assets/blog/distributed_parallel_computing/distributed_system_overview/img_3.png)
