...
- Diameter = 내림(N/2) : 간단히 말해서 가장 멀리 있는 노드로 갈때 필요한 edge의 개수이다. 
...
- Diameter = 2 X (r-1) : 간단히 말해서 가장 멀리 있는 노드로 갈때 필요한 edge의 개수이다. (예시, 앞부분에서 마지막까지 r-1만큼 간 뒤에 r-1만큼 가야함)
...
- Diameter = 2 X 내림(r/2): 간단히 말해서 가장 멀리 있는 노드로 갈때 필요한 edge의 개수이다.
