...
![img_1.png](/assets/blog/cs/tree_insertion_img2.png)

- 6 삽입시 5 오른쪽으로 붙음

![img_2.png](/assets/blog/cs/tree_insertion_img3.png)

- 7 삽입시 5,6,7로 최대 키 갯수 초과하므로 중간값인 6을 상위 노드로 올리는데 그러면 2,4,6으로 역시 개수가 초과되어 중간 값인 4를 상위 노드로 올림

![img_3.png](/assets/blog/cs/tree_insertion_img4.png)
...
![img_4.png](/assets/blog/cs/tree_deletion_img1.png)
